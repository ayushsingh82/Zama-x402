    ...
    <div className="min-h-screen bg-white font-sans tracking-tight relative overflow-x-hidden">
      ...
      <div className="absolute top-6 left-6 z-10">
        ...
        <Link href="/" className="focus:outline-none">
          ...
          <div className="bg-[#FBBF24] border-2 border-black shadow-[6px_6px_0_0_rgba(0,0,0,1)] px-6 py-3 rounded-lg cursor-pointer hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 flex items-center gap-3">
      ...
      <div className="absolute top-6 right-6 z-10">
        ...
        <div className={`connect-button-wrapper border-2 border-black shadow-[6px_6px_0_0_rgba(0,0,0,1)] rounded-lg cursor-pointer hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 ${
          ...
          isConnected ? 'bg-white' : 'bg-[#FBBF24]'
      ...
      <div className="max-w-5xl mx-auto px-4 pb-20 mt-16">
        ...
        <div className="grid grid-cols-12 gap-6 auto-rows-[180px]">
          ...
          <div className="col-span-12 md:col-span-8 row-span-2 bg-white border-2 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] p-8 rounded-2xl flex flex-col justify-center">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start"><span className="text-lg font-extrabold text-[#FBBF24] mr-3">1</span><div><div className="font-bold text-black mb-1 text-sm">Configure Limits</div><div className="text-xs text-black">Define spend limits, rate limits, and usage quotas through our intuitive interface or SDK.</div></div></div>

              <div className="flex items-start"><span className="text-lg font-extrabold text-[#FBBF24] mr-3">2</span><div><div className="font-bold text-black mb-1 text-sm">Integrate SDK</div><div className="text-xs text-black">Add x402 SDK to your application to enforce guardrails on all x402 calls automatically.</div></div></div>

              <div className="flex items-start"><span className="text-lg font-extrabold text-[#FBBF24] mr-3">3</span><div><div className="font-bold text-black mb-1 text-sm">Monitor Usage</div><div className="text-xs text-black">Track real-time usage, spending, and rate limit status through the dashboard with detailed analytics.</div></div></div>

              <div className="flex items-start"><span className="text-lg font-extrabold text-[#FBBF24] mr-3">4</span><div><div className="font-bold text-black mb-1 text-sm">Automatic Enforcement</div><div className="text-xs text-black">When limits are reached, x402 calls are automatically blocked or throttled to prevent abuse and overuse.</div></div></div>
        ...
        <section className="relative z-10 px-4 py-16 border-t border-[#FBBF24]/20 mt-12">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              {faqs.map((faq, index) => (
                ...
                <div key={index} className="border-2 border-[#FBBF24] rounded-2xl overflow-hidden bg-white">

                  <button

                    onClick={() => setExpandedFaq(expandedFaq === index ? null : index)}

                    className="w-full p-6 text-left flex items-center justify-between text-black hover:bg-[#FBBF24] hover:text-black transition-all duration-300 focus:outline-none"
